...
public class AdminPanelController {
     ...
     *
     * @param orderDataDto с новым статусом заказа.
    ...
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    public ResponseEntity<?> changeOrderStatus(@RequestBody OrderDataDto orderDataDto) throws OrderNotFoundException {
     ...
     * @throws EntityNotFoundException если подарок с указанным ID не найден.
     */
